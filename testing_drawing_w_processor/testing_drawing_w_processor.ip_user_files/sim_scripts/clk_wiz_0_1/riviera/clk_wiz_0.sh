...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/rache/OneDrive/Desktop/Duke/ECE350/ece350_final_proj/testing_drawing_w_processor/testing_drawing_w_processor.cache/compile_simlib/riviera"
  fi
  if [[ ($lib_map_path != "") ]]; then
