...
#
# Script generated by Vivado on Fri Mar 27 22:59:38 -0400 2026
...
# script info
echo -e "clk_wiz_1.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/rache/OneDrive/Desktop/Duke/ECE350/ece350_final_proj/ECE350_processor/ECE350_processor.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
...
Usage: clk_wiz_1.sh [-rerun]\n\
Usage: clk_wiz_1.sh [-reset_run]\n\
Usage: clk_wiz_1.sh [-clean]\n\
