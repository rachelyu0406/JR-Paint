...
#
# Generated by export_simulation on Thu Mar 26 16:42:20 -0400 2026
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_5.sh' script.

./clk_wiz_5.sh -reset_run
...
./clk_wiz_5.sh -noclean_files

For more information on the script, please type './clk_wiz_5.sh -help'.
