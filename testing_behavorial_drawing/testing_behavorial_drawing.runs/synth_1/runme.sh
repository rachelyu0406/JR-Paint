...
HD_PWD='C:/Users/rache/OneDrive/Desktop/Duke/ECE350/ece350_final_proj/testing_behavorial_drawing/testing_behavorial_drawing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FinalProjectVGABehavioral.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FinalProjectVGABehavioral.tcl
