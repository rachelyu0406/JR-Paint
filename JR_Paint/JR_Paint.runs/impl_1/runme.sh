...
HD_PWD='C:/Users/rache/OneDrive/Desktop/Duke/ECE350/ece350_final_proj/JR_Paint/JR_Paint.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FinalProjectJRPaint.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FinalProjectJRPaint.tcl -notrace
