...
HD_PWD='C:/Users/rache/OneDrive/Desktop/Duke/ECE350/ece350_final_proj/JR_Paint/JR_Paint.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FinalProjectJRPaint.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FinalProjectJRPaint.tcl
