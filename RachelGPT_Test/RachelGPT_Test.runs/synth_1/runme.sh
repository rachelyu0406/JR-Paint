...
HD_PWD='C:/Users/rache/OneDrive/Desktop/Duke/ECE350/ece350_final_proj/RachelGPT_Test/RachelGPT_Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FinalProjectVGAProcessor2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FinalProjectVGAProcessor2.tcl
